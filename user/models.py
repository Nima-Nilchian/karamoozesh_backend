...
class Favorite_resumes(models.Model):
    user_id = models.ManyToManyField('User', related_name='favorite_resume')
    resume_id = models.ManyToManyField('Resume', related_name='favorite_resume')  # import resume
